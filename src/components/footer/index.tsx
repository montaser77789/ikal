    ...
    <footer className="bg-primary text-white pt-16 pb-8" dir="rtl">
      <div className="container ">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-6">
            ...
            <p className="text-white leading-relaxed">
              مجموعة إيكال للمقاولات العامة - تقدم حلولاً متكاملة في مجال
              الإنشاءات والبنية التحتية بجودة عالية واحترافية.
            </p>
          </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-500">
          <p>
            &copy; {new Date().getFullYear()} شركة إيكال للمقاولات. جميع الحقوق
            محفوظة.
          </p>
